...
class RoomTypeController extends AbstractController
{
    ...
    {
        return $this->render('room_type/index.html.twig', ['room_types' => $roomTypeRepository->findAll()]);
    }
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('room_type_index');
        }
    ...
    {
        return $this->render('room_type/show.html.twig', ['room_type' => $roomType]);
    }
    ...
    public function edit(Request $request, RoomType $roomType): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('room_type_index', ['id' => $roomType->getId()]);
        }
    ...
    /**
     * @Route("/{id}", name="room_type_delete", methods={"DELETE"})
     */
